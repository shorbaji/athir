...
mod regex_generator {
        ...
        ($digit:expr, $radix:expr, $is_decimal:expr) => {
            {
                ...
                let complex = format!(r"({}|{}|{}|{}|{}|{}|{}|{})", complexc, complexe, complexd, complexb, complexf, complexg, complexa, complexh,);
    ...
    pub fn gen_regex() {
        ...
        let boolean_long_true = format!("({}{}{}{})", boolean_letter_t, boolean_letter_r, boolean_letter_u, boolean_letter_e);
        let boolean_long_false = format!("({}{}{}{}{})", boolean_letter_f, boolean_letter_a, boolean_letter_l, boolean_letter_s, boolean_letter_e);
