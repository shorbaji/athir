...
#[test]
fn test_eval_number() {
    test("42", |e| matches!(e, V::Number(n) if n == &Number::from(42)));
}
...
fn test_procedure_call_built_in() {
    test("(identity 1)", |e| matches!(e, V::Number(n) if n == &Number::from(1)));
}

#[test]
fn test_procedure_call_lambda() {
    test("((lambda (x) x) 1)", |e| matches!(e, V::Number(n) if n == &Number::from(1)));
}

#[test]
fn test_procedure_call_lambda_nested() {
    test("((lambda (x) ((lambda (x) x) x)) 1)", |e| matches!(e, V::Number(n) if n == &Number::from(1)));
}
...
#[test]
fn test_if() {
    test("(if #t 1 2)", |e| matches!(e, V::Number(n) if n == &Number::from(1)));
}

#[test]
fn test_if_false() {
    test("(if #f 1 2)", |e| matches!(e, V::Number(n) if n == &Number::from(2)));
}

#[test]
fn test_if_compound_test() {
    test("(if (identity #t) 1 2)", |e| matches!(e, V::Number(n) if n == &Number::from(1)));
}

#[test]
fn test_if_test_not_boolean() {
    test("(if 1 1 2)", |e| matches!(e, V::Number(n) if n == &Number::from(1)));
}

#[test]
fn test_define() {
    test("(define x 1) x", |e| matches!(e, V::Number(n) if n == &Number::from(1)));
}

#[test]
fn test_define_lambda() {
    test("(define x (lambda (x) x)) (x 1)", |e| matches!(e, V::Number(n) if n == &Number::from(1)));
}

#[test]
fn test_set_after_define() {
    test("(define x 1) (set! x 2) x", |e| matches!(e, V::Number(n) if n == &Number::from(2)));
}
